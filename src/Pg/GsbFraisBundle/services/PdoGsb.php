...
*/
	public function getInfosVisiteur($login, $mdp){
                $req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, affectation.refimmat as refimmat from visiteur, affectation
    ...
    public function getListeVehicules($login, $mdp){
                $req = "select nom, immat, marque, modele, couleur from affectation, vehicule,visiteur where visiteur.id = affectation.refvisiteur and affectation.refimmat=vehicule.immat";
        //var_dump($req);
        $stmt = PdoGsb::$monPdo->prepare($req);
                $stmt->bindParam(':log', $login);
        $stmt->bindParam(':md', $mdp);
